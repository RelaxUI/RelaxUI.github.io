      ...
      <div className="flex flex-col gap-2 w-full nowheel nodrag overflow-hidden">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className={`relative w-8 h-4 rounded-full transition-colors ${props.data.allowRemoteModels !== false ? "bg-[var(--relax-accent)]" : "bg-[var(--relax-border)]"}`}
          >
            <div
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className={`relative w-8 h-4 rounded-full transition-colors ${props.data.useBrowserCache !== false ? "bg-[var(--relax-accent)]" : "bg-[var(--relax-border)]"}`}
          >
            <div
