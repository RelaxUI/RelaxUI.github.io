...
export function TopBar({
  ...
  const menuItemClass =
    "w-full text-left px-3 py-2 text-[10px] font-bold text-(--relax-text-default) hover:bg-(--relax-border) rounded hover:text-white transition-colors";
    ...
    <div className="w-full bg-(--relax-bg-primary)/90 backdrop-blur-md border-b border-(--relax-border) flex items-center px-2 sm:px-6 py-2 sm:py-3 z-30 shadow-[0_4px_20px_rgba(0,0,0,0.4)] text-xs font-mono tracking-widest justify-between relative gap-1 sm:gap-0">
      ...
      <div className="flex items-center gap-2 sm:gap-3 shrink-0">
        <div className="w-6 h-6 rounded bg-linear-to-tr from-(--relax-accent) to-[#007acc] flex items-center justify-center shadow-[0_0_10px_rgba(0,229,255,0.4)]">
          <span className="text-(--relax-bg-primary) font-bold text-[14px] leading-none mt-px">
            R
          </span>
        </div>
      ...
      <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
        ...
        <div className="relative" ref={menuRef}>
          ...
          {menuOpen && (
            <div className="absolute right-0 top-full mt-2 w-52 bg-(--relax-bg-elevated) border border-(--relax-border) rounded-lg shadow-2xl z-50 flex flex-col p-1.5">
