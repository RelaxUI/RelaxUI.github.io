  ...
  return (
    <div className="w-full bg-[var(--relax-bg-primary)]/90 backdrop-blur-md border-b border-[var(--relax-border)] flex items-center px-3 sm:px-6 py-3 z-30 shadow-[0_4px_20px_rgba(0,0,0,0.4)] text-xs font-mono tracking-widest justify-between relative">
      ...
      <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
        ...
        {/* Quick actions dropdown — Import/Export always accessible */}
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-2 sm:px-3 py-1.5 bg-[var(--relax-border)] border border-[var(--relax-border-hover)] text-[var(--relax-text-muted)] hover:text-[var(--relax-accent)] hover:border-[var(--relax-accent)] rounded-md transition-all text-[10px] font-bold tracking-wider shadow-lg"
          title="Settings"
        >
          <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
