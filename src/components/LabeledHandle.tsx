...
export const LabeledHandle = ({
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-[9px] font-mono font-bold text-(--relax-accent) tracking-widest whitespace-nowrap bg-(--relax-bg-primary) border border-(--relax-border) px-2 py-1 rounded shadow-[0_4px_12px_rgba(0,0,0,0.8)]">
          {label}
        </span>
      </div>
    </Handle>
