...
export const LabeledHandle = ({
  ...
  return (
    <Handle
      ...
      position={position}
      id={id}
      className={`custom-handle bg-[var(--relax-accent)]! border-0! shadow-[0_0_8px_var(--relax-accent)]! transition-transform z-20! group/handle cursor-crosshair`}
      style={{ top: offsetY }}
    >
      <div
      ...
      >
        <span className="text-[9px] font-mono font-bold text-[var(--relax-accent)] tracking-widest whitespace-nowrap bg-[var(--relax-bg-primary)] border border-[var(--relax-border)] px-2 py-1 rounded shadow-[0_4px_12px_rgba(0,0,0,0.8)]">
          {label}
        </span>
      </div>
    </Handle>
